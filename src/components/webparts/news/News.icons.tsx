...
/** ThumbLikeIcon — Fluent "Thumb Like" 24 (regular/outlined), fourni par Steven.
 *  Utilisé sur le compteur de j'aime du Hero (jintan: Icon iconName='Like'). */
export const ThumbLikeIcon = (props: SVGProps<SVGSVGElement>) => (
