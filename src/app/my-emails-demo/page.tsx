  ...
  return (
    <main className="w-full max-w-[1204px] mx-auto p-lg flex flex-col gap-2xl bg-[#faf9f8] min-h-screen">
      <div className="grid grid-cols-2 gap-xl">
        <MyEmails config={myEmailsDefaultConfig} content={myEmailsSeed('fr-FR')} />
        <MyEmails config={{ ...myEmailsDefaultConfig, height: 296, radius: 8, shadow: 'light' }} content={myEmailsSeed('fr-FR')} />
      </div>
    </main>
  );
}
