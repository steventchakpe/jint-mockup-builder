...
export default function ProfileDemoPage() {
  return (
    <main className="w-full max-w-[1204px] mx-auto p-lg flex flex-col gap-2xl bg-[#faf9f8] min-h-screen">
      <Profile config={{ ...profileDefaultConfig, title: 'Mon profil' }} content={profileSeed('fr-FR')} />
      <Profile config={{ ...profileDefaultConfig, specificProfile: true, shadow: 'strong', radius: 12 }} content={profileSeed('fr-FR')} />
    </main>
  );
}
